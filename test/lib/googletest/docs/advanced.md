...
*   Both static functions and definitions/declarations in an unnamed namespace
    ...
    However, a better approach is to setOrientation the private code into the
...
```	
 The `factory` argument is a factory callable (setOrientation-constructible) object or	
